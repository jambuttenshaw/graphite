...
namespace Graphite
{
	...
	// Taken and modified slightly from ImGui's keycodes
	// Because they already implemented a Windows virtual key -> ImGui key code function
	enum Key : KeyCode
	{
		// Keyboard
		Key_None = 0,
	...
	inline constexpr MouseButton KeyCodeToMouseButton(Key key)
	{
		switch (key)
		{
		case Key_MouseLeft: return MouseButton_Left;
		case Key_MouseRight: return MouseButton_Right;
		case Key_MouseMiddle: return MouseButton_Middle;
		default: return MouseButton_None;
		}
	}

	inline constexpr Key KeyCodeToMouseButton(MouseButton mouseButton)
	{
		switch (mouseButton)
		{
		case MouseButton_Left: return Key_MouseLeft;
		case MouseButton_Right: return Key_MouseRight;
		case MouseButton_Middle: return Key_MouseMiddle;
